...
#    Date: July 2021
#    Availability: https://github.com/uchidalab/time_series_augmentation
#    Method Usage: https://github.com/uchidalab/time_series_augmentation/blob/master/docs/AugmentationMethods.md
#
#***************************************************************************************
import dtw as dtw
...
def permutation(x, max_segments=5, seg_mode="equal"):
    ...
    for i, pat in enumerate(x):
        if num_segs[i] > 1:
            ...
            #changed code to prevent numpy error about ragged sequences
            random.shuffle(splits)
            warp = np.hstack(splits).squeeze()
            ret[i] = pat[warp]
        else:
            ret[i] = pat
    return ret
